...
/***********************************************************************************************************************
* Function Name: r_Config_CSI00_callback_error
...
{
    /* Start user code for r_Config_CSI00_callback_error. Do not edit comment generated here */
    /* End user code. Do not edit comment generated here */
}
...
void r_Config_CSI00_interrupt(void)
{
    ...
    if (1U == err_type)
    {
        r_Config_CSI00_callback_error(err_type);    /* overrun error occurs */
    }
    else
    {
        ...
        else
        {
            ...
            r_Config_CSI00_callback_receiveend();    /* complete receive */
        }
    }
}
